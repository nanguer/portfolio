...
const AboutMePage = ({ navState }) => {
  ...
  const studiesArray = [
    {
      name: "Higher Technician in Telecommunications and Computer Systems",
      link: "https://drive.google.com/open?id=1VXaBlpR0BM1AJtzNbigJCJZms-v7Ymqy"
    },
  ...
  const interest = interestsArray.map(({ id, Icon, text }) => {
    return (
      <div
        key={id}
        className="d-flex flex-column justify-content-center pb-xl-4 pl-xl-3 pr-xl-3"
      >
        <div
        ...
        <div className="d-flex flex-column flex-md-row">
          <div className="studies d-flex flex-column" style={{ zIndex: "2" }}>
            <div className="study-list pt-4">
              ...
              <ul className="text-center text-md-start">{studies}</ul>
            </div>
            <div className="language-list pt-4">
              <h5 className="text-center text-md-start pb-3">
                Language Skills
              </h5>
          ...
          <div className="interests pl-md-5 pt-4 d-flex flex-column">
            <h4 className="text-center text-md-start pb-3">Interests</h4>
            <div className="d-flex flex-column flex-xl-row">{interest}</div>
          </div>
        </div>
      </div>
    </div>
