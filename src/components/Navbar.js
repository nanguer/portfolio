...
export default ({ navState, handleSetNav }) => {
  ...
  useEffect(() => {
    console.log(navState.isDesktop);
  }, [navState.isDesktop]);
          ...
          >
            <div className="full-option" ref={el => (menu1 = el)}>
              <NavLink
                ...
                onMouseEnter={() => handleMouseEnter([menu1, menu1Sec])}
                onMouseLeave={() => handleMouseLeave([menu1, menu1Sec])}
                onClick={() => handleNavClick("Landing", isOpen)}
              >
                <li>Home</li>
                <li ref={el => (menu1Sec = el)} className="second-option">
                  Home
                </li>
              </NavLink>
            </div>
            <div className="full-option" ref={el => (menu2 = el)}>
              <NavLink
                to="/about"
                onMouseEnter={() => handleMouseEnter([menu2, menu2Sec])}
                onMouseLeave={() => handleMouseLeave([menu2, menu2Sec])}
                className="main-option"
                onClick={() => handleNavClick("About", isOpen)}
                exact={true}
              >
                <li> About</li>
                <li ref={el => (menu2Sec = el)} className="second-option">
                  About
                </li>
              </NavLink>
            </div>
            ...
            <div className="full-option" ref={el => (menu3 = el)}>
              <NavLink
                ...
                className="main-option"
                exact={true}
                onMouseEnter={() => handleMouseEnter([menu3, menu3Sec])}
                onMouseLeave={() => handleMouseLeave([menu3, menu3Sec])}
                onClick={() => handleNavClick("Portfolio", isOpen)}
              >
                <li>Works</li>
                <li ref={el => (menu3Sec = el)} className="second-option">
                  Works
                </li>
              </NavLink>
            </div>
            ...
            <div className="full-option" ref={el => (menu4 = el)}>
              <NavLink
                to="/contact"
                className="main-option"
                onMouseEnter={() => handleMouseEnter([menu4, menu4Sec])}
                onMouseLeave={() => handleMouseLeave([menu4, menu4Sec])}
                onClick={() => handleNavClick("Contact", isOpen)}
                exact={true}
              >
                <li> Contact</li>
                <li ref={el => (menu4Sec = el)} className="second-option">
                  {" "}
                  Contact
                </li>
              </NavLink>
